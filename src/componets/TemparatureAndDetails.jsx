    ...
    <div>
      ...
      <div className='flex flex-row items-center justify-between text-white py-3'>
        ...
        <div className='flex flex-col space-y-2'>
          <div className='flex font-light text-sm item-center justify-center'>
            ...
            Real fell:
            <span className='font-medium ml-1'>32°</span> {/* option+shift+8 = degree sign */}
          </div>
          <div className='flex font-light text-sm item-center justify-center'>
            <UilTear size={18} className="mr-1" />
            Humidity:
            <span className='font-medium ml-1'>65%</span> {/* option+shift+8 = degree sign */}
          </div>
          <div className='flex font-light text-sm item-center justify-center'>
            <UilWind size={18} className="mr-1" />
            Wind:
            <span className='font-medium ml-1'>11 km/h</span> {/* option+shift+8 = degree sign */}
          </div>
        </div>
      </div>
      <div className='flex flex-row items-center justify-center space-x-1 text-white text-sm py-3'>
        ...
        <p className='font-light'>
          ...
          <UilSunset />
          <p className='font-light'>
          Set <span className='font-medium ml-1'>06:45 AM</span></p>
          <p className='font-light'>|</p>
